...
class BanglaStories extends StatefulWidget {
  @override
  _BanglaStoriesState createState() => _BanglaStoriesState();
}

class _BanglaStoriesState extends State<BanglaStories> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Bangla Stories", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
