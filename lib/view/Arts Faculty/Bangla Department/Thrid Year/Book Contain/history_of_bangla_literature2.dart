...
class HistoryofBanglaLiterature extends StatefulWidget {
  @override
  _HistoryofBanglaLiteratureState createState() => _HistoryofBanglaLiteratureState();
}

class _HistoryofBanglaLiteratureState extends State<HistoryofBanglaLiterature> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("History of Bangla Literature- II", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
