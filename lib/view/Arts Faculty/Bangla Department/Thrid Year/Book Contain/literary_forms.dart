...
class Literaryforms extends StatefulWidget {
  @override
  _LiteraryformsState createState() => _LiteraryformsState();
}

class _LiteraryformsState extends State<Literaryforms> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Literary forms, literary principles (theory Rasa)", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
