...
class PhonologyandPhonetics extends StatefulWidget {
  @override
  _PhonologyandPhoneticsState createState() => _PhonologyandPhoneticsState();
}

class _PhonologyandPhoneticsState extends State<PhonologyandPhonetics> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Phonology and Phonetics", style: TextStyle(
          color: Colors.black
      ),),
    ),
    /*body: ListView(
