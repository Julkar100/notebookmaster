...
class BengaliPoetry2 extends StatefulWidget {
  @override
  _BengaliPoetry2State createState() => _BengaliPoetry2State();
}

class _BengaliPoetry2State extends State<BengaliPoetry2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Bengali Poetry -2", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
