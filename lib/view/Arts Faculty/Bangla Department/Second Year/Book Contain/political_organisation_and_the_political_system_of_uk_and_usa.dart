...
class PoliticalOrganisation extends StatefulWidget {
  @override
  _PoliticalOrganisationState createState() => _PoliticalOrganisationState();
}

class _PoliticalOrganisationState extends State<PoliticalOrganisation> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Political Organisation and The \nPolitical System of UK and USA", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
