...
class IntroductionPoliticalTheory extends StatefulWidget {
  @override
  _IntroductionPoliticalTheoryState createState() => _IntroductionPoliticalTheoryState();
}

class _IntroductionPoliticalTheoryState extends State<IntroductionPoliticalTheory> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Introduction to Political Theory", style: TextStyle(
