...
class BanglaNovel1 extends StatefulWidget {
  @override
  _BanglaNovel1State createState() => _BanglaNovel1State();
}

class _BanglaNovel1State extends State<BanglaNovel1> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Bangla Novel-1", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
