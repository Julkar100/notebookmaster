...
class BanglaComedyandLiterature extends StatefulWidget {
  @override
  _BanglaComedyandLiteratureState createState() => _BanglaComedyandLiteratureState();
}

class _BanglaComedyandLiteratureState extends State<BanglaComedyandLiterature> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Bangla Comedy and Literature of Traveling", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
