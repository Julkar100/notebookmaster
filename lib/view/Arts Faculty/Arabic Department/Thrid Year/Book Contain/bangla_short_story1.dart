...
class BanglaShortStory extends StatefulWidget {
  @override
  _BanglaShortStoryState createState() => _BanglaShortStoryState();
}

class _BanglaShortStoryState extends State<BanglaShortStory> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Bangla Short Story- I", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
