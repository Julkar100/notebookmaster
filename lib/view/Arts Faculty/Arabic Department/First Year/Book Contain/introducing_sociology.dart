...
class IntroducingSociology extends StatefulWidget {
  @override
  _IntroducingSociologyState createState() => _IntroducingSociologyState();
}

class _IntroducingSociologyState extends State<IntroducingSociology> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Introducing Sociology", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
