...
class BanglaPoetry extends StatefulWidget {
  @override
  _BanglaPoetryState createState() => _BanglaPoetryState();
}

class _BanglaPoetryState extends State<BanglaPoetry> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Bangla Poetry", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
