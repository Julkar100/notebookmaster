...
class PoetryofMedival extends StatefulWidget {
  @override
  _PoetryofMedivalState createState() => _PoetryofMedivalState();
}

class _PoetryofMedivalState extends State<PoetryofMedival> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Poetry of Medieval", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
