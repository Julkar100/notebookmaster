...
class EnglishCompulsory extends StatefulWidget {
  @override
  _EnglishCompulsoryState createState() => _EnglishCompulsoryState();
}

class _EnglishCompulsoryState extends State<EnglishCompulsory> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("English Compulsory", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
