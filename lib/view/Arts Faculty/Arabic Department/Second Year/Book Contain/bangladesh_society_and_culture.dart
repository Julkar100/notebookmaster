...
class BangladeshSocietyandCulture extends StatefulWidget {
  @override
  _BangladeshSocietyandCultureState createState() => _BangladeshSocietyandCultureState();
}

class _BangladeshSocietyandCultureState extends State<BangladeshSocietyandCulture> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Bangladesh Society and Culture", style: TextStyle(
            color: Colors.black
        ),),
      ),
      /*body: ListView(
